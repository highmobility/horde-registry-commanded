defmodule HordeRegistryCommanded.HordeRegistry do
  ...
  """
  @impl Commanded.Registration.Adapter
  def supervisor_child_spec(_adapter_meta, module, _arg) do
    default = [
      strategy: :one_for_one,
      distribution_strategy: Horde.UniformDistribution,
      name: module,
      members: NodeListener.members(__MODULE__)
    ]

    Horde.DynamicSupervisor.child_spec(default)
  end
  ...
  def whereis_name(adapter_meta, name) do
    ...
    Horde.Registry.whereis_name({registry_name, name})
  end
  ...
  defp registry_name(adapter_meta) do
    Map.get(adapter_meta, :registry_name)
  end
end
